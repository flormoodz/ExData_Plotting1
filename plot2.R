...
#PLOT 2: Line graph of Global Active Power(kilowatts) based on time
 plot(file$Global_active_power~file$dateTime, type="l", xlab="", ylab="Global Active Power (kilowatts)")
